...
setenv bootargs "console=ttyS0,115200n8 fbcon=map:off vt.global_cursor_default=0 root=/dev/nfs rw nfsroot=${serverip}:${nfsroot},vers=3,tcp ip=${ipaddr}:${serverip}::${netmask}:bbb:eth0:off"
echo "TFTP kernel..."
